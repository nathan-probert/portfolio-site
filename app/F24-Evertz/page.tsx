    ...
    return (
        <div className="max-w-4xl mx-auto my-3 p-8 relative">
          ...
          <header className="mb-6">
            <h1 className="text-4xl font-bold">Evertz - Fall 2024</h1>
            <p className="text-sm">Published on: January 7, 2025</p>
          </header>
          ...
          <section className="mb-6">
            ...
            <div className="">
              <h3 className="font-semibold">&emsp;-&emsp;Goal 1</h3>
              <p className="ml-6 mb-4">
                &emsp;Improve communication skills by participating in team meetings and brainstorming sessions. Seek feedback on 
                ...
                opportunities to work on this as a new, large project was being introduced in early October. This project had 
                many modular components, so I had to work together with others to create the final result. I used this chance 
                to stay active in the discussion phase, asking clarifying questions and contributing where possible. Additionally, 
              ...
              <h3 className="font-semibold">&emsp;-&emsp;Goal 3</h3>
              <p className="ml-6 mb-4">
                &emsp;Review PRs submitted by colleagues, focusing on coding standards, best practices, and project requirements.
                <br />
                <br />
                ...
                were done. I was also able to spot areas where code could be optimized saving time and money. I received positive 
          ...
          <section className="mb-6">
            ...
            <p className="">
              &emsp;Prabhjot Singh, for his guidance and friendship throughout my work term. He was always available to answer 
              any questions I had and provided valuable feedback on my work. I am grateful for his mentorship and support.
              <br />
              <br />
              &emsp;Joydip Panda, for his patience and encouragement. He challenged me to think critically about my work and
              improve as a developer. I appreciate his dedication to helping me grow in my role. 
            </p>
          </section>
          <img
            src="/images/party-photobooth.png"
            alt="Christmas Party Photobooth Picture"
            width={800}
            height={500}
            className="w-full h-auto"
          />
